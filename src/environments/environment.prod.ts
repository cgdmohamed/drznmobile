export const environment = {
  ...
  // WooCommerce API
  apiUrl: "/wp-json/wc/v3", // For production builds, this will resolve to the server's WC API endpoint
  ...
  // JWT Authentication - using relative path for production builds
